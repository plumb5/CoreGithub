...
namespace P5GenralML
{
    public class MLCrmContact
    {
        ...
        public string? PropStrengthPrimaryContact { get; set; }
        ...
        public string? SizeofUnit { get; set; }
        public string? Budget { get; set; }
        public string? LocationPreference { get; set; }
        public string? PreferenceHouseType { get; set; }
        public string? ReasonForFollowUp { get; set; }
        public string? IspurchaseforSelfUseorInvestment { get; set; }
        public string? WhenDoYouPlantoBuy { get; set; }
        public string? IsOwnHouse { get; set; }
        public string? HasCustomerdecidedonfinancesource { get; set; }
        public string? Customeropenonly2buyfromdeveloper { get; set; }
        public string? ExpectedClosureDate { get; set; }
        public string? EstimatedDateOfConversion { get; set; }
        public string? lastmodifieddate { get; set; }
        public string? CustomField5 { get; set; }
        public string? IsSmsUnsubscribe { get; set; }
        public string? IsSiteVisitCompleted { get; set; }
        public string? AppointmentDone { get; set; }
        public string? VirtualmeetingCount { get; set; }
        public string? HomeVisitDone { get; set; }
        ...
        public bool? IsWhatsappSubscribe { get; set; }
