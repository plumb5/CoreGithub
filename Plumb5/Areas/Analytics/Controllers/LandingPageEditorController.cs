...
namespace Plumb5.Areas.Analytics.Controllers
{
    ...
    public class LandingPageEditorController : BaseController
    {
        ...
        public async Task<JsonResult> UpdateTemplateContent([FromBody] LandingPageEditor_UpdateTemplateContentDto objDto)
        {
            try
            {
                if (objDto.TemplateId > 0)
                {
                    ...
                    myAccount.GetInformationForHome(objDto.UserId);
                    ...
                    string Body = ChangePathAndSaveBEEHTMLImage(objDto.AccountId, objDto.TemplateId, var_HtmlContent);
                    ...
                    SaveLandingPageFile(objDto.AccountId, templateFile);
                    awsUploadOne.UploadFileContent(JsonFileName, var_JsonContent);
        ...
        public string ChangePathAndSaveBEEHTMLImage(int accountId, int templateId, string Body)
        {
