namespace Plumb5.Areas.CaptureForm.Dto
{
    public class FormRulesDto
    {
        ...
        public string? DOBFromDate { get; set; }
        public string? DOBToDate { get; set; }
        ...
        public int CustomerCurrentValueCondition { get; set; }
        public int CustomerTotalPurchaseCondition { get; set; }
        public string? IsNotClickedSpecificButtons { get; set; }
        public int LastPurchaseIntervalCondition { get; set; }
