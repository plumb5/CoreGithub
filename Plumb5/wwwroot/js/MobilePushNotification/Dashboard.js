...
var dashboardUtil = {
    ...
    GetSubcribersDetails: function () {
        $.ajax({
            url: "/MobilePushNotification/Dashboard/GetSubcribersDetails",
            type: 'Post',
            ...
            success: function (SubcribersDetails) {
                ...
                if (SubcribersDetails != null) {
                    ...
                    $("#ui_h1TotalMobilePushSubscribers").html(SubcribersDetails.TotalMobilePushSubcribers);
                    $("#ui_h1TotalMobilePushUnSubscribers").html(SubcribersDetails.TotalMobilePushUnsubcribers);
                    dashboardUtil.BindPlatformDistributionChart(SubcribersDetails.TotalIOS, SubcribersDetails.TotalAndroid);
                }
            },
            error: ShowAjaxError
        });
    ...
    GetFirstEngagementDetails: function () {
        ...
        $.ajax({
            url: "/MobilePushNotification/Dashboard/GetCampaignDetails",
            type: 'Post',
            data: JSON.stringify({ 'accountId': Plumb5AccountId, 'fromDateTime': FromDateTime, 'toDateTime': ToDateTime }),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
    ...
    BindPlatformDistributionChart: function (IOS, Android) {
    ...
    GetNotificationDetails: function () {
        $.ajax({
            url: "/MobilePushNotification/Dashboard/GetNotificationDetails",
            type: 'Post',
            data: JSON.stringify({ 'accountId': Plumb5AccountId, 'fromDateTime': FromDateTime, 'toDateTime': ToDateTime }),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
