...
function MaxCount() {
    ...
    $.ajax({
        url: "/Sms/SmsTemplateArchive/GetArchiveMaxCount",
        type: 'Post',
        data: JSON.stringify({ 'smsTemplate': TemplateDetails }),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (response) {
            TotalRowCount = 0;
...
function GetReport() {
    ...
    $.ajax({
        url: "/Sms/SmsTemplateArchive/GetArchiveTemplateList",
        type: 'Post',
        data: JSON.stringify({ 'smsTemplate': TemplateDetails, 'OffSet': OffSet, 'FetchNext': FetchNext }),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: BindReport,
        error: ShowAjaxError
...
function BindReport(response) {
    ...
    if (response != undefined && response != null) {
        ...
        $.each(response, function () {
            let TemplateName = ReplaceSingleQuote(this.TemplateName);
            let TemplateDescription = ReplaceSingleQuote(this.TemplateDescription);
            let ContentType = "NA";
...
DeleteFormWithConform = function (Id) {
    ...
    $.ajax({
        url: "/Sms/SmsTemplateArchive/RestoreSmsTemplate",
        type: 'POST',
