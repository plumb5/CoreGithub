...
getPrintExport = function (getPageName, print, viewall, recordsperPage) {
    ...
    if (print == 1) {
        getPrint = "<div id='dv_print' style='float: left; margin-left: 5px;'>" +
            "<a href='javascript:void(0)' class='info' style='background-color: Transparent; float: left;position:relative;top:5px' rel='" + getPageName + "' id='btnPrint'>" +
    ...
    var PrintExport = "" + record + AddGroup +
        ...
        "<a href='javascript:void(0)' class='info' style='background-color: Transparent; float: left; position: relative; top: 4px;' rel='" + getPageName + "' id='btnExport'>" +
...
$(document).ready(function () {
    //Start Browser Notification App 
    if (window.location.href.toLowerCase().indexOf("browser/browsernotifysetting") > -1) {
        $('#dvPushNotification').css('display', 'block');
        $('#ui_lnkPushPersmissionSetting').css('background-color', 'rgba(166, 149, 6, 0.1) !important');
    }
    else if (window.location.href.toLowerCase().indexOf("browser/sendnotification") > -1 && window.location.href.toLowerCase().indexOf("pushid=") > -1) {
        $('#dvPushNotification').css('display', 'block');
        $('#ui_lnkMyNotification').css('background-color', 'rgba(166, 149, 6, 0.1) !important');
    }
    else if (window.location.href.toLowerCase().indexOf("browser/sendnotification") > -1) {
        $('#dvPushNotification').css('display', 'block');
        $('#ui_lnkSendNotification').css('background-color', 'rgba(166, 149, 6, 0.1) !important');
    }
    else if (window.location.href.toLowerCase().indexOf("browser/notificationresponses") > -1) {
        $('#dvPushNotification').css('display', 'block');
        $('#ui_lnkNotificationResponses').css('background-color', 'rgba(166, 149, 6, 0.1) !important');
    }
    else if (window.location.href.toLowerCase().indexOf("browser/notifications") > -1) {
        $('#dvPushNotification').css('display', 'block');
        $('#ui_lnkMyNotification').css('background-color', 'rgba(166, 149, 6, 0.1) !important');
    }
    else if (window.location.href.toLowerCase().indexOf("browser/dashboard") > -1) {
        $('#dvPushNotification').css('display', 'block');
        $('#ui_lnkBrowserDashboard').css('background-color', 'rgba(166, 149, 6, 0.1) !important');
    }
    else if (window.location.href.toLowerCase().indexOf("browser/notificationeffectiveness") > -1) {
        $('#dvPushNotification').css('display', 'block');
        $('#ui_lnkMyNotification').css('background-color', 'rgba(166, 149, 6, 0.1) !important');
    }
    else if (window.location.href.toLowerCase().indexOf("browser/effectivenessreport") > -1) {
        $('#dvPushNotification').css('display', 'block');
        $('#ui_lnkMyNotification').css('background-color', 'rgba(166, 149, 6, 0.1) !important');
    }
    else if (window.location.href.toLowerCase().indexOf("browser/visitors") > -1) {
        $('#dvPushNotification').css('display', 'block');
        $('#ui_lnkBrowserVisitors').css('background-color', 'rgba(166, 149, 6, 0.1) !important');
    }
    else if (window.location.href.toLowerCase().indexOf("browser/groups") > -1) {
        $('#dvPushNotification').css('display', 'block');
        $('#ui_lnkBrowserGroups').css('background-color', 'rgba(166, 149, 6, 0.1) !important');
    }
    else if (window.location.href.toLowerCase().indexOf("browser/unsubscribed") > -1) {
        $('#dvPushNotification').css('display', 'block');
        $('#ui_lnkBrowserUnsubsribed').css('background-color', 'rgba(166, 149, 6, 0.1) !important');
    }
    else if (window.location.href.toLowerCase().indexOf("push/send") > -1) {
        $('#dvPushNotification').css('display', 'block');
        $('#ui_lnkSendPushNotification').css('background-color', 'rgba(166, 149, 6, 0.1) !important');
    }
    else if (window.location.href.toLowerCase().indexOf("push/schedules") > -1) {
        $('#dvPushNotification').css('display', 'block');
        $('#ui_lnkNotificationSchedule').css('background-color', 'rgba(166, 149, 6, 0.1) !important');
    }
    else if (window.location.href.toLowerCase().indexOf("push/browserpushreport") > -1) {
        $('#dvPushNotification').css('display', 'block');
        $('#ui_lnkNotificationPushReport').css('background-color', 'rgba(166, 149, 6, 0.1) !important');
    }
    else if (window.location.href.toLowerCase().indexOf("push/pushreport") > -1) {
        $('#dvPushNotification').css('display', 'block');
        $('#ui_lnkNotificationPushReport').css('background-color', 'rgba(166, 149, 6, 0.1) !important');
    }


    //Start Facebook Notification App
    if (window.location.href.toLowerCase().indexOf("facebook/notification/dashboard") > -1) {
        $('#dvFBPushNotification').css('display', 'block');
        $('#ui_lnkFBDashboard').css('background-color', 'rgba(166, 149, 6, 0.1) !important');
    }
    else if (window.location.href.toLowerCase().indexOf("facebook/notification/notifications") > -1) {
        $('#dvFBPushNotification').css('display', 'block');
        $('#ui_lnkFBNotification').css('background-color', 'rgba(166, 149, 6, 0.1) !important');
    }
    else if (window.location.href.toLowerCase().indexOf("facebook/notification/notificationresponses") > -1) {
        $('#dvFBPushNotification').css('display', 'block');
        $('#ui_lnkFBNotificationResponses').css('background-color', 'rgba(166, 149, 6, 0.1) !important');
    }
    else if (window.location.href.toLowerCase().indexOf("facebook/notification/setting") > -1) {
        $('#dvFBPushNotification').css('display', 'block');
        $('#ui_lnkFBPersmissionSetting').css('background-color', 'rgba(166, 149, 6, 0.1) !important');
    }
    else if (window.location.href.toLowerCase().indexOf("facebook/notification/sendnotification") > -1) {
        $('#dvFBPushNotification').css('display', 'block');
        $('#ui_lnkFBSendNotification').css('background-color', 'rgba(166, 149, 6, 0.1) !important');
    }
    else if (window.location.href.toLowerCase().indexOf("facebook/notification/visitors") > -1) {
        $('#dvFBPushNotification').css('display', 'block');
        $('#ui_lnkFBVisitors').css('background-color', 'rgba(166, 149, 6, 0.1) !important');
    }
    else if (window.location.href.toLowerCase().indexOf("facebook/notification/groups") > -1) {
        $('#dvFBPushNotification').css('display', 'block');
        $('#ui_lnkFBGroups').css('background-color', 'rgba(166, 149, 6, 0.1) !important');
    }
});
