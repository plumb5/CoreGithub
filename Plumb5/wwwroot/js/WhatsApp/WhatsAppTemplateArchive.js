...
$(document).ready(function () {
    ...
    ExportFunctionName = "ArchiveReportExport";
});
...
var WhatsAppTemplateUtil = {
    GetCampaign: function () {
        $.ajax({
            url: "/WhatsApp/WhatsAppTemplateArchive/GetCampaignList",
            type: 'POST',
    ...
    BindGroups: function () {
        $.ajax({
            url: "/WhatsApp/WhatsAppTemplateArchive/GetGroupList",
            type: 'POST',
            data: JSON.stringify({ 'accountId': Plumb5AccountId }),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
    ...
    MaxCount: function () {
        ...
        $.ajax({
            url: "/WhatsApp/WhatsAppTemplateArchive/GetArchiveMaxCount",
            type: 'POST',
    ...
    GetReport: function () {
        ...
        $.ajax({
            url: "/WhatsApp/WhatsAppTemplateArchive/GetArchiveReport",
            type: 'Post',
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div id="mailtempaction"
                                                        ...
                                                        <a class="dropdown-item FullControlPermission" data-toggle="modal"
                                                            ...
                                                            href="javascript:void(0);" onclick="WhatsAppTemplateUtil.ShowDeletePopUp(${eachData.Id});">Restore</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    UnArchiveTemplate: function () {
        ShowPageLoading();
        $.ajax({
            url: "/WhatsApp/WhatsAppTemplateArchive/UnArchive",
            type: 'POST',
            data: JSON.stringify({ 'AdsId': Plumb5AccountId, 'Id': UnArchiveid }),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (response) {
                if (response) {
                    UnArchiveid = 0;
                    ShowSuccessMessage(GlobalErrorList.WhatsAppTemplate.UnArchiveTemplate);
                    WhatsAppTemplateUtil.LoadPage();
                }
                else {
                    HidePageLoading();
    ...
    SendIndividualTestWhatsApp: function () {
        $.ajax({
            url: "/WhatsApp/WhatsAppTemplateArchive/SendIndividualTestWhatsAapp",
            type: 'POST',
    ...
    SendGroupTestWhatsApp: function () {
        ...
        $.ajax({
            url: "/WhatsApp/WhatsAppTemplateArchive/SendGroupTestWhatsAapp",
            type: 'POST',
...
$('#ui_btn_next_whats').click(function () {
    ...
    window.location.href = "/WhatsApp/WhatsAppTemplateArchive/CreateWhatsAppTemplateArchive?TempId=" + TemplateId + "&CampaignId=" + CampaignId + "&TemplateName=" + TemplateName + "&TemplateDesc=" + TemplateDesc + "&actionType=" + actionType + "";
});
...
$("#ui_btnunarchiveConfirm").click(function () {
    WhatsAppTemplateUtil.UnArchiveTemplate();
});
...
function CheckWhatsappTemplateExists() {
    ...
    ShowPageLoading();
    $.ajax({
        url: "/WhatsApp/WhatsAppTemplateArchive/GetTemplate",
        type: 'Post',
...
function UpdateTemplateStatus(TemplateId) {
    ShowPageLoading();
    $.ajax({
        url: "/WhatsApp/WhatsAppTemplateArchive/UpdateTemplateStatus",
        type: 'Post',
