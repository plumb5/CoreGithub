...
var subscribersUtil = {
    ...
    MaxCount: function () {
        ShowPageLoading();
        $.ajax({
            url: "/ManageContact/PushSubscribers/GetMaxCount",
            type: 'Post',
            data: JSON.stringify({ 'AccountId': Plumb5AccountId, 'webPushUser': subscribers, 'GroupId': GroupId }),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (response) {
                TotalRowCount = 0;
    ...
    GetSubscribers: function () {
        ...
        $.ajax({
            url: "/ManageContact/PushSubscribers/GetDetails",
            type: 'Post',
            data: JSON.stringify({ 'AccountId': Plumb5AccountId, 'webPushUser': subscribers, 'Offset': OffSet, 'FetchNext': FetchNext, 'GroupId': GroupId }),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
