var dltvalue = 0, TypeName, Channel;
function addinbox() {
...
$(document).ready(function () {
    ...
    $('#btnAddScoretosources').click(function () {
        ...
        if (document.getElementById('txtScore').value != '') {
            ...
            var urlsearch = '/Areas/Analytics/Handlers/bindallsources.ashx?AccountId=' + AccountIdall + '&type=addsource&searchval=' + document.getElementById('hdnSources').value + '&score=' + document.getElementById('txtScore').value + '&Channel=' + $('#drp_Channel').val();
    ...
    $('#btnAddScoretosourceType').click(function () {
        ...
        if (document.getElementById('txtSourceTypeScore').value != '') {
            document.getElementById('dvLoading').style.display = "block";
            var AccountIdall = document.getElementById('hdn_AccountId').value;
            var urlsearch = '/Areas/Analytics/Handlers/bindallsources.ashx?AccountId=' + AccountIdall + '&type=addsourceType&searchval=' + document.getElementById('hdnSources').value + '&score=' + document.getElementById('txtSourceTypeScore').value + '&Channel=' + $('#drp_Channel').val();
            $.getJSON(urlsearch, function (json) {
                $.each(json, function (i, weed) {
                    if (weed.pocketnumbershtml == "Success") {
                        GetBindSourceTypes();
        ...
        //$('#chkBindSources').prop('checked', false);
        $("input[name='sourcetypes']:checkbox").prop('checked', false);
    });
    $('#btnAddPageScore').click(function () {
        if (document.getElementById('hdnSources').value != '5') {
            document.getElementById('hdnSources').value = '0';
            $('#dvPages input:checked').each(function () {
                document.getElementById('hdnSources').value += ',' + $(this).attr('value').replace('#', '~');
            });
        }
        if (document.getElementById('hdnSources').value == "0") {
        ...
        if (document.getElementById('txtPageScores').value != '') {
            ...
            var urlsearch = '/Areas/Analytics/Handlers/bindallsources.ashx?AccountId=' + AccountIdall + '&type=addpages&searchval=' + document.getElementById('hdnSources').value + '&score=' + document.getElementById('txtPageScores').value + '&Channel=' + $('#drp_Channel').val();
            $.getJSON(urlsearch, function (json) {
                $.each(json, function (i, weed) {
                    if (weed.pocketnumbershtml == "Success") {
                        BindPages();
    ...
    $('#btnTimeDuration').click(function () {
        ...
        if (document.getElementById('txtTimeScore').value != '') {
            ...
            var urlsearch = '/Areas/Analytics/Handlers/bindallsources.ashx?AccountId=' + AccountIdall + '&type=addtimes&searchval=' + e.options[e.selectedIndex].value + '&score=' + document.getElementById('txtTimeScore').value + '&timetext=' + e.options[e.selectedIndex].text + '&Channel=' + $('#drp_Channel').val();
    ...
    $('#btnAddPageDepth').click(function () {
        ...
        if (document.getElementById('txtPageDepthScore').value != '') {
            ...
            var urlsearch = '/Areas/Analytics/Handlers/bindallsources.ashx?AccountId=' + AccountIdall + '&type=adddepths&searchval=' + e.options[e.selectedIndex].value + '&score=' + document.getElementById('txtPageDepthScore').value + '&timetext=' + e.options[e.selectedIndex].text + '&Channel=' + $('#drp_Channel').val();
    ...
    $('#btnAddFrequency').click(function () {
        ...
        if (document.getElementById('txtFrequencyScore').value != '') {
            var AccountIdall = document.getElementById('hdn_AccountId').value;
            var urlsearch = '/Areas/Analytics/Handlers/bindallsources.ashx?AccountId=' + AccountIdall + '&type=addfrequency&searchval=' + e.options[e.selectedIndex].value + '&score=' + document.getElementById('txtFrequencyScore').value + '&timetext=' + e.options[e.selectedIndex].text + '&Channel=' + $('#drp_Channel').val();
            $.getJSON(urlsearch, function (json) {
                $.each(json, function (i, weed) {
                    if (weed.pocketnumbershtml == "Success") {
                        GetBindFrequency();
    ...
    $('#btnAddRecency').click(function () {
        ...
        if (document.getElementById('txtRecencyScore').value != '') {
            ...
            var urlsearch = '/Areas/Analytics/Handlers/bindallsources.ashx?AccountId=' + AccountIdall + '&type=addrecency&searchval=' + e.options[e.selectedIndex].value + '&score=' + document.getElementById('txtRecencyScore').value + '&timetext=' + e.options[e.selectedIndex].text + '&Channel=' + $('#drp_Channel').val();
    ...
    $('#btnAddEventScore').click(function () {
        ...
        if (document.getElementById('txtEventScores').value != '') {
            ...
            var urlsearch = '/Areas/Analytics/Handlers/bindallsources.ashx?AccountId=' + AccountIdall + '&type=addevents&searchval=' + document.getElementById('hdnSources').value + '&score=' + document.getElementById('txtEventScores').value + '&Channel=' + $('#drp_Channel').val();
            $.getJSON(urlsearch, function (json) {
                $.each(json, function (i, weed) {
                    if (weed.pocketnumbershtml == "Success") {
                        BindEvents();
    ...
    $('#btnAddGroupScore').click(function () {
        ...
        if (document.getElementById('txtGroupScores').value != '') {
            ...
            var urlsearch = '/Areas/Analytics/Handlers/bindallsources.ashx?AccountId=' + AccountIdall + '&type=addgroups&searchval=' + document.getElementById('hdnSources').value + '&score=' + document.getElementById('txtGroupScores').value + '&Channel=' + $('#drp_Channel').val();
            $.getJSON(urlsearch, function (json) {
                $.each(json, function (i, weed) {
                    if (weed.pocketnumbershtml == "Success") {
                        BindGroups();
    ...
    $('#txtpagescore').autocomplete({
        source: "/Areas/Analytics/Handlers/bindallsources.ashx?AccountId=" + document.getElementById('hdn_AccountId').value + "&type=typopage&Channel=" + $("#drp_Channel option:selected").val() + "",
        minLength: 1,
        focus: function (event, ui) {
            $(event.target).val(ui.item.label);
            return false;
    ...
    $('#txtEventsScores').autocomplete({
        source: "/Areas/Analytics/Handlers/bindallsources.ashx?AccountId=" + document.getElementById('hdn_AccountId').value + "&type=typoevents&Channel=" + $("#drp_Channel option:selected").val() + "",
        minLength: 1,
        focus: function (event, ui) {
            $(event.target).val(ui.item.label);
            return false;
    ...
    $('#txtGroupsScores').autocomplete({
        source: "/Areas/Analytics/Handlers/bindallsources.ashx?AccountId=" + document.getElementById('hdn_AccountId').value + "&type=typogroups&Channel=" + $("#drp_Channel option:selected").val() + "",
        minLength: 1,
        focus: function (event, ui) {
            $(event.target).val(ui.item.label);
            return false;
...
$("#drp_Channel").change(function () {
    ...
    $('#txtGroupsScores').val('');
    $('#dvFilterNameGroups').hide(500);
    if ($('#hdnTabType').val() == '#tblpages') {
        BindPages();
    }
    if ($('#hdnTabType').val() == '#tbltimes') {
        $('#ddlAvgTimeDuration').val(10);
        $('#txtTimeScore').val('');
        GetBindTimes();
    }
    if ($('#hdnTabType').val() == '#tbldepths') {
        $('#ddlPageDepths').val(1);
        $('#txtRecencyScore').val('');
        GetBindPageDepths();
    }
    if ($('#hdnTabType').val() == '#tblfrequency') {
        $('#ddlFrequency').val(1);
        $('#txtFrequencyScore').val('');
        GetBindFrequency();
    }
    if ($('#hdnTabType').val() == '#tblrecency') {
        $('#ddlRecency').val(0);
        $('#txtRecencyScore').val('');
        GetBindRecency();
    }
    if ($('#hdnTabType').val() == '#tblevents') {

        BindEvents();
    }
    if ($('#hdnTabType').val() == '#tDLGroups') {
        BindGroups();
    }
    $('#txtEventsScores').autocomplete({
        source: "/Areas/Analytics/Handlers/bindallsources.ashx?AccountId=" + document.getElementById('hdn_AccountId').value + "&type=typoevents&Channel=" + $("#drp_Channel option:selected").val() + "",
...
function BindSources() {
    ...
    $.getJSON(urlsearch, function (json) {
        $.each(json, function (i, weed) {
            if (weed.pocketnumbershtml != 'Scores added for all sources') {
                $('#chkBindSources').prop('checked', false);
                $('#dvSelectSource').show();
                $('#dvSearchSource').show();
                $('#dvSourceScore').show();
                $('#dvBindSources').css('border-bottom', '1px solid #eeeeee');
                $('#dvBindSources').css('border-top', '1px solid rgb(238, 238, 238)');
                $('#dvBindSources').css('text-align', 'left');
                $('#dvBindSources').css('margin-top', '0px');
            }
            else {
                $('#dvSourceScore').hide();
                $('#dvSelectSource').hide();
                $('#dvSearchSource').hide();
                $('#dvBindSources').css('border-bottom', '0px');
                $('#dvBindSources').css('border-top', '0px');
                $('#dvBindSources').css('text-align', 'center');
                $('#dvBindSources').css('margin-top', '110px');
            }
...
function GetBindEvents() {
    ...
    $(document).ready(function () {
        var urlsearch = '/Areas/Analytics/Handlers/bindallsources.ashx?AccountId=' + AccountId + '&type=getevents&Channel=' + Channel;
        $.getJSON(urlsearch, function (json) {
            $.each(json, function (i, weed) {
...
function GetBindGroups() {
    ...
    Channel = $('#drp_Channel').val();
    $(document).ready(function () {
        var urlsearch = '/Areas/Analytics/Handlers/bindallsources.ashx?AccountId=' + AccountId + '&type=getgroups&Channel=' + Channel;
        $.getJSON(urlsearch, function (json) {
            $.each(json, function (i, weed) {
                window.divcontent.innerHTML = weed.pocketnumbershtml;
                if (window.divcontent.innerHTML == '') {
...
function GetBindSourceTypes() {
    ...
    $.getJSON(urlsearch, function (json) {
        ...
        if ($('#divcontent').children().length == 8)
        {
            $('#dvsourceTypeScore').hide();
            $('#dvBindSourceType').css('border-bottom', '0px');
            $('#dvBindSourceType').css('border-top', '0px');
            $('#dv_Msg').show();
        }
        else {
            $('#dvsourceTypeScore').show();
            $('#dvBindSourceType').css('border-bottom', '1px solid #eeeeee');
            $('#dv_Msg').hide();
        }
        $("#dvExpend").css({ 'height': $("#dvControlPanel").height() + 20 });
        if (window.divcontent.innerHTML != '') {
...
function GetBindPages() {
    ...
    Channel = $('#drp_Channel').val();
    $(document).ready(function () {
        var urlsearch = '/Areas/Analytics/Handlers/bindallsources.ashx?AccountId=' + AccountId + '&type=getpage&Channel=' + Channel;
        $.getJSON(urlsearch, function (json) {
            $.each(json, function (i, weed) {
                window.divcontent.innerHTML = weed.pocketnumbershtml;
                if (window.divcontent.innerHTML == '') {
...
function GetBindTimes() {
    ...
    Channel = $('#drp_Channel').val();
    $(document).ready(function () {
        var urlsearch = '/Areas/Analytics/Handlers/bindallsources.ashx?AccountId=' + AccountId + '&type=gettime&Channel=' + Channel;
        $.getJSON(urlsearch, function (json) {
            $.each(json, function (i, weed) {
                window.divcontent.innerHTML = weed.pocketnumbershtml;
                if (window.divcontent.innerHTML == '') {
...
function GetBindPageDepths() {
    ...
    Channel = $('#drp_Channel').val();
    $(document).ready(function () {
        var urlsearch = '/Areas/Analytics/Handlers/bindallsources.ashx?AccountId=' + AccountId + '&type=getdepth&Channel=' + Channel;
        $.getJSON(urlsearch, function (json) {
            $.each(json, function (i, weed) {
                window.divcontent.innerHTML = weed.pocketnumbershtml;
                if (window.divcontent.innerHTML == '') {
...
function GetBindFrequency() {
    ...
    Channel = $('#drp_Channel').val();
    $(document).ready(function () {
        var urlsearch = '/Areas/Analytics/Handlers/bindallsources.ashx?AccountId=' + AccountId + '&type=getfrequency&Channel=' + Channel;
        $.getJSON(urlsearch, function (json) {
            $.each(json, function (i, weed) {
                window.divcontent.innerHTML = weed.pocketnumbershtml;
                if (window.divcontent.innerHTML == '') {
...
function GetBindRecency() {
    ...
    Channel = $('#drp_Channel').val();
    $(document).ready(function () {
        var urlsearch = '/Areas/Analytics/Handlers/bindallsources.ashx?AccountId=' + AccountId + '&type=getrecency&Channel=' + Channel;
        $.getJSON(urlsearch, function (json) {
            $.each(json, function (i, weed) {
                window.divcontent.innerHTML = weed.pocketnumbershtml;
                if (window.divcontent.innerHTML == '') {
...
function BindPages() {
    ...
    Channel = $('#drp_Channel').val();
    $(document).ready(function () {
        var urlsearch = '/Areas/Analytics/Handlers/bindallsources.ashx?AccountId=' + AccountId + '&type=pages&Channel=' + Channel;
        $.getJSON(urlsearch, function (json) {
            $.each(json, function (i, weed) {
                if (weed.pocketnumbershtml != 'Scores added for all pages') {
                    $('#chpagesall').prop('checked', false);
                    $('#dvSelectPage').show();
                    $('#dvSearchPage').show();
                    $('#dvpageScore').show();
                    $('#dvPages').css('border-bottom', '1px solid #eeeeee');
                    $('#dvPages').css('border-top', '1px solid rgb(238, 238, 238)');
                    $('#dvPages').css('text-align', 'left');
                    $('#dvPages').css('margin-top', '0px');
                }
                else {
                    $('#dvPages').css('border-bottom', '0px');
                    $('#dvPages').css('border-top', '0px');
                    $('#dvpageScore').hide();
                    $('#dvSelectPage').hide();
                    $('#dvSearchPage').hide();
                    $('#dvPages').css('text-align','center');
                    $('#dvPages').css('margin-top', '110px');
                }
...
function BindEvents() {
    ...
    Channel = $('#drp_Channel').val();
    $(document).ready(function () {
        var urlsearch = '/Areas/Analytics/Handlers/bindallsources.ashx?AccountId=' + AccountId + '&type=events&Channel=' + Channel;
        $.getJSON(urlsearch, function (json) {
            $.each(json, function (i, weed) {
                if (weed.pocketnumbershtml != 'No events found') {
                    $('#dvEventsScore').show();
                    $('#chkEventsAll').prop('checked', false);
                    $('#dvselectevent').show();
                    $('#dvSearchEvent').show();
                    $('#dvEvents').css('border-bottom', '1px solid #eeeeee');
                    $('#dvEvents').css('border-top', '1px solid rgb(238, 238, 238)');
                    $('#dvEvents').css('text-align', 'left');
                    $('#dvEvents').css('margin-top', '0px');
                }
                else {
                    $('#dvEventsScore').hide();
                    $('#dvEvents').css('border-bottom', '0px');
                    $('#dvEvents').css('border-top', '0px');
                    $('#dvEvents').css('text-align', 'center');
                    $('#dvEvents').css('margin-top', '110px');
                    $('#dvselectevent').hide();
                    $('#dvSearchEvent').hide();
                }
...
function BindGroups() {
    ...
    Channel = $('#drp_Channel').val();
    $(document).ready(function () {
        var urlsearch = '/Areas/Analytics/Handlers/bindallsources.ashx?AccountId=' + AccountId + '&type=groups&Channel=' + Channel
        $.getJSON(urlsearch, function (json) {
            $.each(json, function (i, weed) {
                if (weed.pocketnumbershtml !='No groups found') {
                    $('#chkGroupsAll').prop('checked', false);
                    $('#dvselectgroup').show();
                    $('#dvsearchgroup').show();
                    $('#dvGroupScore').show();
                    $('#dvGroups').css('border-bottom', '1px solid #eeeeee');
                    $('#dvGroups').css('border-top', '1px solid rgb(238, 238, 238)');
                    $('#dvGroups').css('text-align', 'left');
                    $('#dvGroups').css('margin-top', '0px');
                }
                else {
                    $('#dvGroupScore').hide();
                    $('#dvGroups').css('border-bottom', '0px');
                    $('#dvGroups').css('border-top', '0px');
                    $('#dvGroups').css('text-align', 'center');
                    $('#dvGroups').css('margin-top', '110px');
                    $('#dvselectgroup').hide();
                    $('#dvsearchgroup').hide();
                }
...
function BindAllTypes(obj) {
    ...
    if (obj == 'source') {
        ...
        var urlsearch = '/Areas/Analytics/Handlers/bindallsources.ashx?AccountId=' + AccountIdall + '&type=' + obj + '&searchval=' + srchval + '&Channel=' + Channel;
        $.getJSON(urlsearch, function (json) {
            $.each(json, function (i, weed) {
                document.getElementById('dvPages').innerHTML = weed.pocketnumbershtml;
                showdvscore(2);
