...
function GetReport() {
    $.ajax({
        url: "/Analytics/Audience/GetTimeSpend",
        type: 'Post',
...
function BindReport(response) {
    ...
    if (response != undefined && response != null && response.TimeSpendData.Table1 != undefined && response.TimeSpendData.Table1 != null && response.TimeSpendData.Table1.length > 0) {

        $.each(response.TimeSpendData.Table1, function () {
            ...
            reportTableTrs += "<tr>" +
                "<td>" + this.Time + "</td>" +
                "<td>" + this.Session + "</td>" +
                "<td>" + (this.UniqueVisits != "0" ? "<a class='ViewPermission' href='/Analytics/Uniques/UniqueVisits?dur=" + duration + "&Frm=" + FromDateTime + "&To=" + ToDateTime + "&Time=" + this.Time + "'>" + this.UniqueVisits + "</a>" : this.UniqueVisits) + "</td>" +
