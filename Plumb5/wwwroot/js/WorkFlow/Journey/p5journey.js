    ...
    jsPlumbUtil = {
        ...
        theta: function (c, b) {
            return a(c, b, function (f, e) {
                var d = jsPlumbUtil.gradient(f, e),
                    g = Math.atan(d),
                    h = jsPlumbUtil.segment(f, e);
                if ((h == 4 || h == 3)) {
                    g += Math.PI
                }
                if (g < 0) {
        ...
        pointOnLine: function (b, f, c) {
            var e = jsPlumbUtil.gradient(b, f),
                k = jsPlumbUtil.segment(b, f),
                i = c > 0 ? jsPlumbUtil.segmentMultipliers[k] : jsPlumbUtil.inverseSegmentMultipliers[k],
                d = Math.atan(e),
                g = Math.abs(c * Math.sin(d)) * i[1],
                h = Math.abs(c * Math.cos(d)) * i[0];
            return {
                x: b.x + h,
                y: b.y + g
            }
        ...
        perpendicularLineTo: function (d, e, f) {
            var c = jsPlumbUtil.gradient(d, e),
                g = Math.atan(-1 / c),
                h = f / 2 * Math.sin(g),
                b = f / 2 * Math.cos(g);
            return [{
...
(function () {
    ...
    var c = function (k) {
                ...
                if (v) {
                    for (var s = 0; s < v.childNodes.length; s++) {
                        if (v.childNodes[s].nodeType != 3 && v.childNodes[s].nodeType != 8) {
                            var u = n.getElementObject(v.childNodes[s]),
                                w = k.getId(u, null, true);
                            if (w && e[w] && e[w] > 0) {
                                var t = n.getOffset(u);
                                f[q][w] = {
                                    id: w,
        ...
        this.updateOffsets = function (p) {
            var s = jsPlumb.CurrentLibrary,
                n = s.getElementObject(p),
                m = k.getId(n),
                o = f[m],
                l = s.getOffset(n);
            if (o) {
                for (var r in o) {
                    var t = s.getElementObject(r),
                        q = s.getOffset(t);
                    f[m][r] = {
                        id: r,
                        offset: {
...
(function () {
    var g = jsPlumbUtil.findWithFunction,
        D = jsPlumbUtil.indexOf,
        y = jsPlumbUtil.removeWithFunction,
        k = jsPlumbUtil.remove,
        q = jsPlumbUtil.addWithFunction,
        i = jsPlumbUtil.addToList,
        l = jsPlumbUtil.isArray,
        x = jsPlumbUtil.isString,
        t = jsPlumbUtil.isObject;
    var A = function (E, F) {
        ...
        z = window.jsPlumbUIComponent = function (X) {
            ...
            this.isDropAllowed = function (af, ac, ad, aa, ab) {
                var ae = R._jsPlumb.checkCondition("beforeDrogetp", {
                    sourceId: af,
                    targetId: ac,
                    scope: ad,
                    connection: aa,
            ...
            var G = n.CurrentLibrary,
                F = ["click", "dblclick", "mouseenter", "mouseout", "mousemove", "mousedown", "mouseup", "contextmenu"],
                Q = {
                    mouseout: "mouseexit"
                },
                K = function (ac, ad, ab) {
        ...
        v = window.overlayCapableJsPlumbUIComponent = function (J) {
            ...
            var H = function (V) {
                ...
                if (l(V)) {
                    ...
                    if (V.constructor == String) {
                        T = new n.Overlays[R._jsPlumb.getRenderMode()][V]({
                            component: R,
                            _jsPlumb: R._jsPlumb
                        })
                    } else {
            ...
            if (J.label) {
                var N = J.labelLocation || R.defaultLabelLocation || 0.5,
                    O = J.labelStyle || R._jsPlumb.Defaults.LabelStyle || n.Defaults.LabelStyle;
    ...
    var u = function (F) {
        ...
        var K = null,
            ...
            aQ = function (a9, bc, bb, ba) {
                if (!jsPlumbAdapter.headless && !aM) {
                    var bd = A(a9, "id"),
                        a7 = a0.dragManager.getElementsForDraggable(bd);
                    if (bb == null) {
                        bb = p()
                    }
            ...
            aS = function (bb, a7, be) {
                if (!jsPlumbAdapter.headless) {
                    var bg = a7 == null ? false : a7,
                        bc = n.CurrentLibrary;
                    if (bg) {
                        if (bc.isDragSupported(bb) && !bc.isAlreadyDraggable(bb)) {
                            var bf = be || a0.Defaults.DragOptions || n.Defaults.DragOptions;
                            bf = n.extend({}, bf);
                            var bd = bc.dragEvents.drag,
                                a8 = bc.dragEvents.stop,
                                ba = bc.dragEvents.start;
                            bf[ba] = ae(bf[ba], function () {
                                a0.setHoverSuspended(true);
                                a0.select({
                                    source: bb
                                }).addClass(a0.elementDraggingClass + " " + a0.sourceElementDraggingClass, true);
                                a0.select({
                                    target: bb
                                }).addClass(a0.elementDraggingClass + " " + a0.targetElementDraggingClass, true)
                            });
                            ...
                            bf[a8] = ae(bf[a8], function () {
                                ...
                                a0.select({
                                    source: bb
                                }).removeClass(a0.elementDraggingClass + " " + a0.sourceElementDraggingClass, true);
                                a0.select({
                                    target: bb
                                }).removeClass(a0.elementDraggingClass + " " + a0.targetElementDraggingClass, true)
                            });
                            var a9 = E(bb);
                            aZ[a9] = true;
                            var bg = aZ[a9];
            ...
            W = function (bb) {
                var ba = a0.Defaults.ConnectionType || a0.getDefaultConnectionType(),
                    a9 = a0.Defaults.EndpointType || n.Endpoint,
                    a8 = n.CurrentLibrary.getParent;
                if (bb.container) {
                ...
                var a7 = new ba(bb);
                a7.id = bb.id != undefined ? bb.id : "con_" + ad();//p5 change
                a4("click", "click", a7);
            ...
            ai = function (a9) {
                if (a9.container) {
                    ...
                    var a7 = n.CurrentLibrary.getTagName(a9.source),
                        a8 = n.CurrentLibrary.getParent(a9.source);
        ...
        this.addEndpoint = function (ba, bb, bl) {
            ...
            ba = au(ba);
            var bd = [],
                bg = (l(ba) || (ba.length != null && !x(ba))) ? ba : [ba];
        ...
        var aN = function (ba, bc, a7) {
            var a9 = a0.Defaults.ConnectionType || a0.getDefaultConnectionType(),
                a8 = ba.constructor == a9,
                bb = a8 ? {
                    connection: ba,
                    source: ba.source,
                    target: ba.target,
        ...
        this.detach = function () {
            ...
            var bb = a0.Defaults.ConnectionType || a0.getDefaultConnectionType(),
                bc = arguments[0].constructor == bb,
                ba = arguments.length == 2 ? bc ? (arguments[1] || {}) : arguments[0] : arguments[0],
                bf = (ba.fireEvent !== false),
                a8 = ba.forceDetach,
                a9 = bc ? arguments[0] : ba.connection;
            if (a9) {
                if (a8 || jsPlumbUtil.functionChain(true, false, [
                        [a9.endpoints[0], "isDetachAllowed", [a9]],
                        [a9.endpoints[1], "isDetachAllowed", [a9]],
                        [a9, "isDetachAllowed", [a9]],
                        [a0, "checkCondition", ["beforeDetach", a9]]
                ])) {
        ...
        this.getConnections = function (bh, a8) {
            ...
            var bg = bh.scope || a0.getDefaultScope(),
                bf = a3(bg, true),
                a7 = a3(bh.source),
                bd = a3(bh.target),
                bb = (!a8 && bf.length > 1) ? {} : [],
        ...
        var M = function (bc, bd) {
            var a7 = {
                ...
                bb = ["setHover", "removeAllOverlays", "setLabel", "addClass", "addOverlay", "removeOverlay", "removeOverlays", "showOverlay", "hideOverlay", "showOverlays", "hideOverlays", "setPaintStyle", "setHoverPaintStyle", "setSuspendEvents", "setParameter", "setParameters", "setVisible", "repaint", "addType", "toggleType", "removeType", "removeClass", "setType", "bind", "unbind"],
                ba = ["getLabel", "getOverlay", "isHover", "getParameter", "getParameters", "getPaintStyle", "getHoverPaintStyle", "isVisible", "hasType", "getType", "isSuspendEvents"];
        ...
        this.selectEndpoints = function (bi) {
            bi = bi || {};
            bi.scope = bi.scope || "*";
            var ba = !bi.element && !bi.source && !bi.target,
                bd = ba ? "*" : a3(bi.element),
                a7 = ba ? "*" : a3(bi.source),
                bm = ba ? "*" : a3(bi.target),
                bf = a3(bi.scope, true);
                ...
                if (bj || bg || bn) {
                    inner: for (var bh = 0, bb = aC[a8].length; bh < bb; bh++) {
                        ...
                        if (aq(bf, be.scope, true)) {
                            var bk = (bl && a7.length > 0 && !be.isSource),
                                a9 = (bc && bm.length > 0 && !be.isTarget);
                            if (bk || a9) {
                                continue inner
                            }
                            bo.push(be)
        ...
        this.init = function () {
            if (!H) {
                a0.anchorManager = new n.AnchorManager({
                    jsPlumbInstance: a0
                });
        ...
        this.makeAnchor = function () {
            var bb = function (be, bf) {
                ...
                if (!a0.Defaults.DoNotThrowErrors) {
                    throw {
                        msg: "jsPlumb: unknown anchor type '" + be + "'"
                    }
                }
            };
            if (arguments.length == 0) {
        ...
        this.makeTarget = function (ba, bb, bi) {
            ...
            n.extend(a8, bb);
            T(a8, 1);
            var bf = n.CurrentLibrary,
                bg = a8.scope || a0.Defaults.Scope,
                bc = !(a8.deleteEndpointsOnDetach === false),
                a9 = a8.maxConnections || -1,
                a7 = a8.onMaxConnections;
            _doOne = function (bn) {
                var bl = E(bn);
                aI[bl] = a8;
                aW[bl] = a8.uniqueEndpoint, ag[bl] = a9, ac[bl] = true, proxyComponent = new z(a8);
                var bk = n.extend({}, a8.dropOptions || {}),
                    bj = function () {
                        var bq = n.CurrentLibrary.getDropEvent(arguments),
                            bs = a0.select({
                                target: bl
                            }).length;
                        a0.currentlyDragging = false;
                        var bC = e(bf.getDragObject(arguments)),
                            br = A(bC, "dragId"),
                            bA = A(bC, "originalScope"),
                            bx = aV[br],
                            bp = bx.endpoints[0],
                            bo = a8.endpoint ? n.extend({}, a8.endpoint) : {};
                        ...
                        if (bv) {
                            ...
                            if (bB.anchor.positionFinder != null) {
                                var by = bf.getUIPosition(arguments, a0.getZoom()),
                                    bu = r(bn, a0),
                                    bz = a(bn),
                                    bt = bB.anchor.positionFinder(by, bu, bz, bB.anchor.constructorParams);
                                bB.anchor.x = bt[0];
                                bB.anchor.y = bt[1]
                            }
                            var bw = a0.connect({
        ...
        var ak = {},
            ...
            J = {},
            ac = {},
            aD = function (a8, bd, a7) {
                var bb = a8.target || a8.srcElement,
                    ba = false,
                    bc = a0.getSelector(bd, a7);
        ...
        this.makeSource = function (bb, bc, bh) {
            ...
            T(a9, 0);
            var bf = n.CurrentLibrary,
                ba = a9.maxConnections || -1,
                a8 = a9.onMaxConnections,
                a7 = function (bp) {
                    var bj = E(bp),
                        br = function () {
                    ...
                    V[bi] = true;
                    var bk = bf.dragEvents.stop,
                        bo = bf.dragEvents.drag,
                        bq = n.extend({}, a9.dragOptions || {}),
                        bm = bq.drag,
                        bs = bq.stop,
                        bt = null,
                        bn = false;
                    ...
                    bq[bk] = ae(bq[bk], function () {
                        ...
                        if (bt.connections.length == 0) {
                            ...
                            var bv = a9.anchor || a0.Defaults.Anchor,
                                bw = bt.anchor,
                                by = bt.connections[0];
                            ...
                            if (a9.parent) {
                                ...
                                if (bx) {
                                    var bu = bt.elementId,
                                        bz = a9.container || a0.Defaults.Container || n.Defaults.Container;
                                    bt.setElement(bx, bz);
                    ...
                    var bl = function (by) {
                        ...
                        if (a9.filter) {
                            var bF = bf.getOriginalEvent(by),
                                bu = jsPlumbUtil.isString(a9.filter) ? aD(bF, bp, a9.filter) : a9.filter(bF, bp);
                            if (bu === false) {
                                return
                            }
                        }
                        ...
                        var bD = Q({
                            ...
                            bA = a0.getZoom(),
                            bC = (((by.pageX || by.page.x) / bA) - bD.left) / bD.width,
                            bB = (((by.pageY || by.page.y) / bA) - bD.top) / bD.height,
                            bI = bC,
                            bH = bB;
                        if (a9.parent) {
                            var bz = br(),
            ...
            if (x(bb)) {
                ...
                if (bb.length) {
                    ...
                    for (var a9 = 0, ba = bb.length; a9 < ba; a9++) {
                        var be = _el = n.CurrentLibrary.getElementObject(bb[a9]),
                            be = E(_el);
                        a8[be] = a7 ? !a8[be] : bd
                    }
                }
        ...
        this.removeAllEndpoints = function (a8, a9) {
            var a7 = function (bf) {
                var bb = jsPlumbUtil.isString(bf) ? bf : E(e(bf)),
                    be = aC[bb];
                if (be) {
        ...
        this.setId = function (a9, ba, be) {
            var a7 = a9.constructor == String ? a9 : a0.getId(a9),
                a8 = a0.getConnections({
                    source: a7,
                    scope: "*"
                }, true),
                bc = a0.getConnections({
                    target: a7,
                    scope: "*"
                }, true);
            ba = "" + ba;
        ...
        this.sizeCanvas = function (a9, a7, bb, a8, ba, type) {//p5change
            if (a9) {

                if (type == "TopCenter") {
                    a9.style.height = "65px";// ba + "px";
                    a9.height = ba;
                    a9.style.width = "206px"; //a8 + "px";
                    a9.width = a8;
                    a9.style.left = (a7 - 30) + "px";
                    a9.style.top = (bb + 23) + "px";
                    //a9.style.display = "none";
                    //a9.style.background = "red";

                    a9.title = "target" + a9.id;

                }
                else {
                    a9.style.height = "25px";// ba + "px";
                    a9.height = ba;
                    a9.style.width = "auto"; //a8 + "px";
                    a9.width = a8;
                    a9.style.left = (a7) + "px";
                    a9.style.top = (bb + 0) + "px";
                }
            }
        ...
        this.getTestHarness = function () {
            return {
                endpointsByElement: aC,
                endpointCount: function (a7) {
                    var a8 = aC[a7];
        ...
        this.adjustForParentOffsetAndScroll = function (bc, a9) {
            ...
            if (ba != null) {
                var a8 = ba.tagName.toLowerCase() === "body" ? {
                    ...
                    bb = ba.tagName.toLowerCase() === "body" ? {
                        left: 0,
                        top: 0
                    } : {
                        left: ba.scrollLeft,
...
(function () {
    jsPlumb.AnchorManager = function (w) {
        var e = {},
            ...
            h = {},
            p = w.jsPlumbInstance,
            f = jsPlumb.CurrentLibrary,
            n = {},
            k = function (K, L, G, C, H, A) {
                if (K === L) {
                    return {
                        orientation: v.IDENTITY,
                        a: ["top", "top"]
                    }
                }
                var B = Math.atan2((C.centery - G.centery), (C.centerx - G.centerx)),
                    F = Math.atan2((G.centery - C.centery), (G.centerx - C.centerx)),
                    E = ((G.left <= C.left && G.right >= C.left) || (G.left <= C.right && G.right >= C.right) || (G.left <= C.left && G.right >= C.right) || (C.left <= G.left && C.right >= G.right)),
                    J = ((G.top <= C.top && G.bottom >= C.top) || (G.top <= C.bottom && G.bottom >= C.bottom) || (G.top <= C.top && G.bottom >= C.bottom) || (C.top <= G.top && C.bottom >= G.bottom)),
                    I = function (M) {
                        return [H.isContinuous ? H.verifyEdge(M[0]) : M[0], A.isContinuous ? A.verifyEdge(M[1]) : M[1]]
                    },
                    D = {
                        orientation: v.DIAGONAL,
                        theta: B,
                        theta2: F
                    };
                if (!(E || J)) {
            ...
            c = function (B, A) {
                var D = B[0][0] < 0 ? -Math.PI - B[0][0] : Math.PI - B[0][0],
                    C = A[0][0] < 0 ? -Math.PI - A[0][0] : Math.PI - A[0][0];
                if (D > C) {
                    return 1
                } else {
            ...
            i = function (B, A) {
                var F = p.getCachedData(B),
                    D = F.s,
                    E = F.o,
                    C = function (M, T, I, L, R, Q, H) {
                        if (L.length > 0) {
                            var P = q(L, s[M]),
                                N = M === "right" || M === "top",
                                G = z(M, T, I, P, R, Q, N);
                            ...
                            for (var J = 0; J < G.length; J++) {
                                var O = G[J][4],
                                    S = O.endpoints[0].elementId === B,
                                    K = O.endpoints[1].elementId === B;
                                if (S) {
                                    U(O.endpoints[0], G[J])
                                } else {
                                    if (K) {
        ...
        this.connectionDetached = function (F) {
            var B = F.connection || F,
                E = F.sourceId,
                C = F.targetId,
                A = B.endpoints,
                D = function (G, H, J, I, K) {
                    if (J.constructor == jsPlumb.FloatingAnchor) { } else {
        ...
        var l = function (U, H, P, E, K, L, N, J, W, M, D, T) {
            var R = -1,
                ...
                B = U[W],
                V = F._continuousAnchorEdge ? U[F._continuousAnchorEdge] : null;
            if (V) {
            ...
            if (!p.isSuspendDrawing()) {
                ...
                for (var X = 0; X < aa.length; X++) {
                    var G = aa[X][0],
                        I = G.sourceId,
                        E = G.targetId,
                        H = G.endpoints[0].anchor.isContinuous,
                        N = G.endpoints[1].anchor.isContinuous;
                    if (H || N) {
                        var Y = I + "_" + E,
                            U = E + "_" + I,
                            T = L[Y],
        ...
        var t = function (C) {
            ...
            var F = C.faces || ["top", "right", "bottom", "left"],
                B = !(C.clockwise === false),
                K = {},
                I = {
                    top: "bottom",
    ...
    jsPlumb.FloatingAnchor = function (e) {
        ...
        var d = e.reference,
            ...
            h = e.jsPlumbInstance,
            i = e.referenceCanvas,
            l = f.getSize(f.getElementObject(i)),
            m = 0,
            g = 0,
            c = null,
            k = null;
    ...
    b(0.04, 1, -1, 1, "Bottom1");
    b(0.20, 1, -1, 0, "Bottom2");
    b(0.40, 1, -1, 0, "Bottom3");
    b(0.60, 1, -1, 0, "Bottom4")
    b(0.80, 1, -1, 0, "Bottom5");
    b(0.96, 1, -1, 0, "Bottom6");

    //b(0.04, 1, -1, 1, "Bottom1");
    //b(0.20, 1, -1, 0, "Bottom2");
    //b(0.45, 1, -1, 0, "Bottom3");
    //b(0.55, 1, -1, 0, "Bottom4")
    //b(0.75, 1, -1, 0, "Bottom5");
    //b(0.95, 1, -1, 0, "Bottom6");

    //b(0.04, 1, -1, 1, "Bottom1");
    //b(0.30, 1, -1, 0, "Bottom2");
    //b(0.45, 1, -1, 0, "Bottom3");
    //b(0.52, 1, -1, 0, "Bottom4")
    //b(0.70, 1, -1, 0, "Bottom5");
    //b(0.90, 1, -1, 0, "Bottom6"); 
    ...
    jsPlumb.Defaults.DynamicAnchors = function (c) {
        return c.jsPlumbInstance.makeAnchors(["TopCenter", "Bottom1", "Bottom2", "Bottom3", "Bottom4", "Bottom5", "Bottom6"], c.elementId, c.jsPlumbInstance)
    };
    ...
    var a = function (d, c) {
        jsPlumb.Anchors[d] = function (f) {
            var e = f.jsPlumbInstance.makeAnchor(["Continuous", {
                faces: c
            }], f.elementId, f.jsPlumbInstance);
            e.type = d;
            return e
        }
    };
...
(function () {
    ...
    jsPlumb.Endpoint = function (h) {
        var r = this,
            t = h._jsPlumb,
            k = jsPlumb.CurrentLibrary,
            H = k.getAttribute,
            Z = k.getElementObject,
            q = jsPlumbUtil,
            g = k.getOffset,
            Y = h.newConnection,
            P = h.newEndpoint,
            W = h.finaliseConnection,
            X = h.fireDetachEvent,
            B = h.floatingConnections;
        ...
        this.setEndpoint = function (ab) {
            var i = function (ae, ag) {
                ...
                if (!t.Defaults.DoNotThrowErrors) {
                    throw {
                        msg: "jsPlumb: unknown endpoint type '" + ae + "'"
                    }
                }
            };
            var ac = {
        ...
        this.setElement = function (ae, ab) {
            ...
            V = t.getId(I);
            r.elementId = V;
            var af = h.getParentFromParams({
                source: ag,
                container: ab
            }),
                ad = k.getParent(r.canvas);
        ...
        r.makeInPlaceCopy = function () {
            var ad = r.anchor.getCurrentLocation(r),
                ac = r.anchor.getOrientation(r),
                ab = r.anchor.getCssClass(),
                i = {
                    bind: function () { },
                    compute: function () {
                        return [ad[0], ad[1]]
        ...
        this.paint = function (af) {
            ...
            if (!al || r.timestamp !== al) {
                ...
                if (at) {
                    var ai = af.anchorPoint,
                        ag = af.connectorPaintStyle;
                    if (ai == null) {
                        ...
                        if (ak && r.anchor.isDynamic && r.connections.length > 0) {
                            var an = C(af.elementWithPrecedence),
                                ar = an.endpoints[0] == r ? 1 : 0,
                                ah = ar == 0 ? an.sourceId : an.targetId,
                                aq = t.getCachedData(ah),
                                am = aq.o,
                                ao = aq.s;
        ...
        if (k.isDragSupported(I)) {
            ...
            var A = function () {
                ...
                var ah = Z(J.canvas),
                    af = g(ah, t),
                    ac = t.adjustForParentOffsetAndScroll([af.left, af.top], J.canvas),
                    ab = Z(r.canvas);
                k.setOffset(aa.element, {
                    left: ac[0],
                    top: ac[1]
                });
                if (r.parentAnchor) {
            ...
            var n = h.dragOptions || {},
                u = jsPlumb.extend({}, k.defaultDragOptions),
                N = k.dragEvents.start,
                T = k.dragEvents.stop,
                F = k.dragEvents.drag;
        ...
        var p = function (ac, ah, af, ai) {
            if ((h.isTarget || ah) && k.isDropSupported(I)) {
                ...
                var ab = k.dragEvents.drop,
                    ag = k.dragEvents.over,
                    i = k.dragEvents.out,
                    ae = function () {
                        r.removeClass(t.endpointDropAllowedClass);
                        r.removeClass(t.endpointDropForbiddenClass);
                        var aj = k.getDropEvent(arguments),
                            ax = Z(k.getDragObject(arguments)),
                            al = H(ax, "dragId"),
                            an = H(ax, "elId"),
                            aw = H(ax, "originalScope"),
                            aq = B[al];
                        ...
                        if (aq != null) {
                            var at = aq.floatingAnchorIndex == null ? 1 : aq.floatingAnchorIndex,
                                au = at == 0 ? 1 : 0;
                            if (aw) {
                            ...
                            if (!r.isFull() && !(at == 0 && !r.isSource) && !(at == 1 && !r.isTarget) && av) {
                                ...
                                var ak = function () {
                                    ...
                                    if (!aq.suspendedEndpoint) {
                                        ...
                                        var aA = aq.suspendedEndpoint.getElement(),
                                            ay = aq.suspendedEndpoint.elementId;
                                        X({
                ...
                ad[ag] = t.wrap(ad[ag], function () {
                    var ak = k.getDragObject(arguments),
                        ao = H(Z(ak), "dragId"),
                        an = B[ao];
                    if (an != null) {
    ...
    jsPlumb.Connection = function (b) {
        ...
        var B = function (O, R, Q) {
            ...
            if (!o.Defaults.DoNotThrowErrors && jsPlumb.Connectors[R] == null) {
                throw {
                    msg: "jsPlumb: unknown connector type '" + R + "'"
                }
            }
        ...
        this.setConnector = function (Q, O) {
            ...
            if (y && jsPlumb.ConnectorEditors != null && jsPlumb.ConnectorEditors[d.type] && d.isEditable()) {
                new jsPlumb.ConnectorEditors[d.type]({
                    connector: d,
                    connection: l,
                    params: b.editorParams || {}
                })
            } else {
                y = false
            }
        ...
        var x = function (P, O) {
            ...
            A = function (O, U, P, R, S, Q, T) {
                ...
                if (O) {
                    ...
                    var W = P.anchors ? P.anchors[U] : P.anchor ? P.anchor : x(o.Defaults.Anchors[U], S) || x(jsPlumb.Defaults.Anchors[U], S) || x(o.Defaults.Anchor, S) || x(jsPlumb.Defaults.Anchor, S),
                        Z = P.uuids ? P.uuids[U] : null;
                    V = E({
                        paintStyle: Y,
                        hoverPaintStyle: X,
                        endpoint: aa,
        ...
        if (!o.isSuspendDrawing()) {
            var H = o.getCachedData(this.sourceId),
                e = H.o,
                u = H.s,
                ...
                C = p.s,
                M = t || o.timestamp(),
                k = this.endpoints[0].anchor.compute({
                    xy: [e.left, e.top],
                    wh: u,
        ...
        this.moveParent = function (R) {
            var Q = jsPlumb.CurrentLibrary,
                P = Q.getParent(d.canvas);
            if (d.bgCanvas) {
        ...
        this.paint = function (ag) {
            if (r) {
                ...
                var X = ag.elId,
                    ...
                    Q = ag.timestamp,
                    Z = false,
                    af = Z ? this.sourceId : this.targetId,
                    T = Z ? this.targetId : this.sourceId,
                    R = Z ? 0 : 1,
                    ai = Z ? 1 : 0;
                if (Q == null || Q != v) {
                    ...
                    var S = ab.anchor.getCurrentLocation(ab),
                        ae = P.anchor.getCurrentLocation(P);
                    d.resetBounds();
                    d.compute({
                        sourcePos: S,
                        targetPos: ae,
                    ...
                    var O = parseFloat(l.paintStyleInUse.lineWidth || 1) / 2,
                        ah = parseFloat(l.paintStyleInUse.lineWidth || 0),
                        ac = {
...
(function () {
    ...
    jsPlumb.Segments = {
        ...
        Straight: function (k) {
            var q = this,
                o = jsPlumb.Segments.AbstractSegment.apply(this, arguments),
                h, i, p, g, f, n, l, e = function () {
                    h = Math.sqrt(Math.pow(f - g, 2) + Math.pow(l - n, 2));
                    i = jsPlumbUtil.gradient({
                        x: g,
                        y: n
                    }, {
                        x: f,
                ...
                if (i == 0) {
                    ...
                    if (i == Infinity || i == -Infinity) {
                        ...
                        var m = n - (i * g),
                            ...
                            t = (s - m) / (i - p),
                            w = (i * t) + m,
                            v = jsPlumbUtil.lineLength([r, z], [t, w]),
                            u = jsPlumbUtil.lineLength([t, w], [g, n]);
                        return {
                            d: v,
                            x: t,
                            y: w,
        ...
        Arc: function (i) {
            var q = this,
                p = jsPlumb.Segments.AbstractSegment.apply(this, arguments),
                l = function (s, r) {
                    return jsPlumbUtil.theta([i.cx, i.cy], [s, r])
                },
                e = function (t) {
                    if (q.anticlockwise) {
                        var r = q.startAngle < q.endAngle ? q.startAngle + h : q.startAngle,
                            v = Math.abs(r - q.endAngle);
                        return r - (v * t)
                    } else {
                        var u = q.endAngle < q.startAngle ? q.endAngle + h : q.endAngle,
                            v = Math.abs(u - q.startAngle);
            ...
            this.pointOnPath = function (r, v) {
                ...
                var u = e(r),
                    t = i.cx + (i.r * Math.cos(u)),
                    s = i.cy + (i.r * Math.sin(u));
                return {
                    x: n(t),
                    y: n(s),
                    theta: u
            ...
            this.pointAlongPathFrom = function (z, r, y) {
                var t = q.pointOnPath(z, y),
                    s = r / o * 2 * Math.PI,
                    u = q.anticlockwise ? -1 : 1,
                    x = t.theta + (u * s),
                    w = i.cx + (q.radius * Math.cos(x)),
                    v = i.cy + (q.radius * Math.sin(x));
                return {
                    x: w,
                    y: v
                }
        ...
        Bezier: function (k) {
            var e = this,
                g = jsPlumb.Segments.AbstractSegment.apply(this, arguments),
                i = [{
                    x: k.x1,
                    y: k.y1
                }, {
    ...
    jsPlumb.Connectors.AbstractConnector = function (z) {
        ...
        var u = this,
            ...
            s = [],
            e = z.stub || 0,
            l = jsPlumbUtil.isArray(e) ? e[0] : e,
            r = jsPlumbUtil.isArray(e) ? e[1] : e,
            v = z.gap || 0,
            m = jsPlumbUtil.isArray(v) ? v[0] : v,
            o = jsPlumbUtil.isArray(v) ? v[1] : v,
            n = null,
            i = false,
            k = null;
        this.isEditable = function () {
        ...
        var q = function (R) {
            ...
            var B = jsPlumbUtil.segment(R.sourcePos, R.targetPos),
                N = R.targetPos[0] < R.sourcePos[0],
                L = R.targetPos[1] < R.sourcePos[1],
                E = R.lineWidth || 1,
                Q = R.sourceEndpoint.anchor.orientation || R.sourceEndpoint.anchor.getOrientation(R.sourceEndpoint),
                C = R.targetEndpoint.anchor.orientation || R.targetEndpoint.anchor.getOrientation(R.targetEndpoint),
                H = N ? R.targetPos[0] : R.sourcePos[0],
                G = L ? R.targetPos[1] : R.sourcePos[1],
                J = Math.abs(R.targetPos[0] - R.sourcePos[0]),
                P = Math.abs(R.targetPos[1] - R.sourcePos[1]);
    ...
    jsPlumb.Connectors.Bezier = function (k) {
        k = k || {};
        var f = this,
            h = jsPlumb.Connectors.AbstractConnector.apply(this, arguments),
            i = k.stub || 50,
            e = k.curviness || 150,
            g = 10;
        this.type = "Bezier";
        ...
        this._findControlPoint = function (u, l, r, m, o) {
            var s = m.anchor.getOrientation(m),
                t = o.anchor.getOrientation(o),
                q = s[0] != t[0] || s[1] == t[1],
                n = [];
            if (!q) {
                if (s[0] == 0) {
        ...
        this._compute = function (q, n) {
            var o = n.sourcePos,
                ...
                m = o[0] < v[0] ? 0 : w,
                l = o[1] < v[1] ? 0 : s,
                x = f._findControlPoint([t, r], o, v, n.sourceEndpoint, n.targetEndpoint),
                u = f._findControlPoint([m, l], v, o, n.targetEndpoint, n.sourceEndpoint);
            h.addSegment("Bezier", {
                x1: t,
                y1: r,
                x2: m,
    ...
    jsPlumb.Endpoints.Dot = function (g) {
        this.type = "Dot";
        var e = this,
            f = jsPlumb.Endpoints.AbstractEndpoint.apply(this, arguments);
        g = g || {};
    ...
    jsPlumb.Endpoints.Rectangle = function (g) { //p5change
        ...
        g = g || {};
        //console.log(this.);
        this.width = g.width || 150;
        this.height = g.height || 50;
        this._compute = function (n, k, p, m) {
            var l = p.width || e.width,
                i = p.height || e.height,
                h = n[0] - (l / 2),
                o = n[1] - (i / 2);
            return [h, o, l, i]
    ...
    jsPlumb.Endpoints.Image = function (k) {
        ...
        var p = this,
            o = jsPlumb.Endpoints.AbstractEndpoint.apply(this, arguments),
            i = false,
            h = false,
            g = k.width,
            f = k.height,
        ...
        var n = function (t, s, r) {
            if (!h) {
                ...
                var q = p.anchorPoint[0] - (g / 2),
                    u = p.anchorPoint[1] - (f / 2);
        ...
        this.draw = function (v, z) {
            ...
            if (v.pointAlongPathFrom) {
                ...
                var t = {
                    ...
                    u = h.strokeStyle || z.strokeStyle,
                    x = h.fillStyle || z.strokeStyle,
                    p = h.lineWidth || z.lineWidth,
                    m = {
                        component: v,
                        d: t,
                        lineWidth: p,
    ...
    var a = function (f) {
        ...
        var g = function () {
            ...
            if (f.title != undefined) { e.style.color = "transparent"; e.title = f.title; } //p5 change
        ...
        this.paint = function (p, o) {
            ...
            e.style.left = (p.component.x + p.d.minx) + "px";//p5change
    ...
    jsPlumb.Overlays.GuideLines = function () {
        ...
        this.draw = function (g, m) {
            var l = g.pointAlongPathFrom(e.loc, e.length / 2),
                k = g.pointOnPath(e.loc),
                i = jsPlumbUtil.pointOnLine(l, k, e.length),
                h = jsPlumbUtil.perpendicularLineTo(l, i, 40),
                f = jsPlumbUtil.perpendicularLineTo(i, l, 20);
            return {
                connector: g,
                head: l,
                tail: i,
    ...
    jsPlumb.Overlays.Label = function (i) {//p5change
        var e = this;
...
(function () {
    ...
    jsPlumb.Connectors.StateMachine = function (g) {
        ...
        var m = this,
            k = jsPlumb.Connectors.AbstractConnector.apply(this, arguments),
            d = g.curviness || 10,
            h = g.margin || 5,
            i = g.proximityLimit || 80,
            e = g.orientation && g.orientation === "clockwise",
            f = g.loopbackRadius || 25,
            l = g.showLoopback !== false;
        this._compute = function (v, O) {
            var G = Math.abs(O.sourcePos[0] - O.targetPos[0]),
                M = Math.abs(O.sourcePos[1] - O.targetPos[1]),
                E = Math.min(O.sourcePos[0], O.targetPos[0]),
                C = Math.min(O.sourcePos[1], O.targetPos[1]);
            if (!l || (O.sourceEndpoint.elementId !== O.targetEndpoint.elementId)) {
                var u = O.sourcePos[0] < O.targetPos[0] ? 0 : G,
                    r = O.sourcePos[1] < O.targetPos[1] ? 0 : M,
                    J = O.sourcePos[0] < O.targetPos[0] ? G : 0,
                    H = O.sourcePos[1] < O.targetPos[1] ? M : 0;
                if (O.sourcePos[2] === 0) {
                    u -= h
                }
                if (O.sourcePos[2] === 1) {
                ...
                var D = (u + J) / 2,
                    ...
                    n = (-1 * D) / A,
                    K = Math.atan(n),
                    F = (n == Infinity || n == -Infinity) ? 0 : Math.abs(d / 2 * Math.sin(K)),
                    I = (n == Infinity || n == -Infinity) ? 0 : Math.abs(d / 2 * Math.cos(K)),
                    o = a(u, r, J, H),
                    z = Math.sqrt(Math.pow(J - u, 2) + Math.pow(H - r, 2)),
                    B = b(D, A, o, O.sourcePos, O.targetPos, d, d, z, i);
                k.addSegment("Bezier", {
                    x1: J,
                    y1: H,
                    x2: u,
...
(function () {
    jsPlumb.Connectors.Flowchart = function (params) {
        ...
        var self = this,
            ...
            lastx = null,
            lasty = null,
            lastOrientation, cornerRadius = params.cornerRadius != null ? params.cornerRadius : 0,
            sgn = function (n) {
                    ...
                    perpendicular: function (axis, ss, oss, es, oes) {
                        with (paintInfo) {
                            var sis = {
                                ...
                                stubs = {
                                    x: [
                                        [startStubX, endStubX], null, [endStubX, startStubX]
                                    ],
                                    y: [
                                        [startStubY, endStubY], null, [endStubY, startStubY]
                                    ]
                                },
                                midLines = {
                                    x: [
...
(function () {
        ...
        SegmentRenderer: {
            getPath: function (i) {
                return ({
                    ...
                    Arc: function (z) {
                        var B = z.params,
                            u = Math.min(B.x1, B.x2),
                            y = Math.max(B.x1, B.x2),
                            C = Math.min(B.y1, B.y2),
                            w = Math.max(B.y1, B.y2),
                            A = z.anticlockwise ? 1 : 0,
                            v = (z.anticlockwise ? "at " : "wa "),
                            x = function () {
                                var D = [null, [function () {
                                    return [u, C]
                                }, function () {
    ...
    var o = function (x, v) {
        ...
        this.paint = function (C, D) {
            ...
            var y = Math.min(I.hxy.x, I.tail[0].x, I.tail[1].x, I.cxy.x),
                L = Math.min(I.hxy.y, I.tail[0].y, I.tail[1].y, I.cxy.y),
                E = Math.max(I.hxy.x, I.tail[0].x, I.tail[1].x, I.cxy.x),
                A = Math.max(I.hxy.y, I.tail[0].y, I.tail[1].y, I.cxy.y),
                K = Math.abs(E - y),
                G = Math.abs(A - L),
                F = [y, L, K, G];
            z.path = i(I);
...
(function () {
    var l = {
        ...
        v = function (O, J, G, E, K) {
            ...
            for (var L = 0; L < G.gradient.stops.length; L++) {
                var I = K.segment == 1 || K.segment == 2 ? L : G.gradient.stops.length - 1 - L,
                    N = jsPlumbUtil.convertStyle(G.gradient.stops[I][1], true),
                    P = f(a, {
    ...
    var s = function (J) {
        ...
        if (J.useDivWrapper) {
            E.canvas = document.createElement("div");
            E.canvas.id = "endnode_" + J.originalArgs[0].parent.prevObject.selector.replace('#', ''); //p5 change
            E.canvas.style.position = "absolute";
        ...
        this.paint = function (N, M, O) {
            if (N != null) {
                ...
                if (J.useDivWrapper) {
                    jsPlumb.sizeCanvas(E.canvas, Q[0], Q[1], L[0], L[1], M.type);
                    Q[0] = 0, Q[1] = 0;
                    P = n([0, 0])
                } else {
                    P = n([Q[0], Q[1]])
    ...
    var d = jsPlumb.ConnectorRenderers.svg = function (G) {
        ...
        F.renderer.paint = function (H, L, Q) {
            ...
            var R = {
                ...
                N = [E.x, E.y, E.w, E.h];
            if (H.outlineColor) {
                var P = H.outlineWidth || 1,
                    S = H.lineWidth + (2 * P),
                    O = jsPlumb.CurrentLibrary.extend({}, H);
        ...
        SegmentRenderer: {
            getPath: function (E) {
                return ({
                    ...
                    Arc: function () {
                        var H = E.params,
                            F = E.sweep > Math.PI ? 1 : 0,
                            G = E.anticlockwise ? 0 : 1;
    ...
    var p = function (I, G) {
        ...
        this.paint = function (M, J) {
            if (M.component.svg && J) {
                ...
                var K = G && (G.length == 1) ? (G[0].cssClass || "") : "",
                    L = [0, 0];
                if (J.xmin < 0) {
                    L[0] = -J.xmin
                }
...
(function () {
    ...
    var a = {
        ...
        b = Math.pow(2, -65),
        f = function (z, y) {
            for (var u = [], w = y.length - 1, t = 2 * w - 1, s = [], v = [], p = [], r = [], q = [
                    [1, 0.6, 0.3, 0.1],
                    [0.4, 0.6, 0.6, 0.4],
                    [0.1, 0.3, 0.6, 1]
            ], x = 0; x <= w; x++) {
    ...
    window.jsBezier = {
        distanceFromCurve: f,
        gradientAtPoint: g,
        gradientAtPointAlongCurveFrom: function (n, m, o) {
            m = k(n, m, o);
        ...
        nearestPointOnCurve: function (n, m) {
            var o = f(n, m);
            return {
                point: h(m, m.length - 1, o.location, null, null),
                location: o.location
            }
        },
        pointOnCurve: l,
