...
var MailBounced = { BounceType: "hard", ReasonForBounce: "", Category: "" };
...
var BounceUtil = {
    ...
    MaxCount: function () {
        ShowPageLoading();
        MailBounced = { BounceType: "hard", ReasonForBounce: "", Category: "" };
        ...
        $.ajax({
            url: "/Mail/BouncedHard/GetMaxCount",
            type: 'POST',
    ...
    GetReport: function () {
        ...
        $.ajax({
            url: "/Mail/BouncedHard/GetBouncedContactList",
            type: 'Post',
    ...
    BindGroupList: function () {
        $.ajax({
            url: "/Mail/BouncedHard/GetGroupList",
            type: 'POST',
    ...
    DeleteBounceRecord: function () {
        ...
        $.ajax({
            url: "/Mail/BouncedHard/DeleteBounceRecord",
            type: 'POST',
    ...
    AddRemoveBounceRecord: function () {
        //var SelectedGroups = $('#ui_ddlGroup').select2().val();
        ...
        //$.ajax({
        //    url: "/Mail/BouncedHard/RemoveBouncedContactFromGroup",
        //    type: 'POST',
        //    data: JSON.stringify({
        //        'accountId': Plumb5AccountId, 'bounceList': CheckBoxDataList, 'GroupIds': SelectedGroups
        //    }),
        //    contentType: "application/json; charset=utf-8",
        //    dataType: "json",
        //    success: function (response) {
        //        if (response != undefined && response != null && response.Status) {
        //            ShowSuccessMessage(GlobalErrorList.MailBounce.RemovedFromGroupSuccess);
        ...
        if (chkArrayContactId.length > 0 && PresentContactGroupId.length > 0) {
            $.ajax({
                type: "POST",
                url: "/Mail/BouncedHard/AddToGroup",
        ...
        if (chkArrayContactId.length > 0 && deleteGroup.length > 0) {
            $.ajax({
                type: "POST",
                url: "/Mail/BouncedHard/DeleteFromGroup",
    ...
    ExportUnsubscribedContacts: function () {
        ...
        $.ajax({
            url: "/Mail/BouncedHard/ExportUnsubscribedContacts",
            type: 'POST',
            data: JSON.stringify({
