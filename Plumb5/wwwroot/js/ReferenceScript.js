...
var onlineLinkUrl = "$$$OnlineUrl/", plumb5ChatDomain = "$$$ChatDomain/"; 
var plumb5DesktopNoti = false, machineId, chatAdsId = $$AdsId, myIframe, errorCountI = 0;
...
function ChatAppendScriptToFrame() {
    setTimeout(function () {
        AppendChatJavascriptIframes(myIframe.contentWindow.document, linksUrl + "js/json2.min.js", "json");
        AppendChatStyleIframes(document, linksUrl + "images/p5ChatImagesStyle.css");
        AppendChatStyleIframes(myIframe.contentWindow.document, linksUrl + "images/ChatStyle.css");
...
function JqueryForSlimScroll() {
    AppendChatJavascriptIframes(myIframe.contentWindow.document, linksUrl + "js/PlumbChatjquery.min.js", "SlimScrollJquery", AppendSignalRJs);
    setTimeout(function () { AppendChatJavascriptIframes(myIframe.contentWindow.document, linksUrl + "js/slimScroll.js", "SlimScroll"); }, 100);
}
function AppendSignalRJs() {
    AppendChatJavascriptIframes(myIframe.contentWindow.document, linksUrl + "scripts/jquery.signalR-2.1.0.js", "signalRJS", AppendHubsJs);
}
...
function AppendPlumbChatJs() {
    AppendChatJavascriptIframes(myIframe.contentWindow.document, linksUrl + "js/NewChat.js", "chatJs");
}
