...
var dashboardUtil = {
    GetTotalFormSubmissions: function () {
        $.ajax({
            url: "/CaptureForm/Dashboard/GetTotalFormSubmissions",
            type: 'Post',
    ...
    GetTopFivePerFormingForms: function () {
        $.ajax({
            url: "/CaptureForm/Dashboard/GetTopFivePerFormingForms",
            type: 'Post',
            data: JSON.stringify({ 'accountId': Plumb5AccountId, 'fromDateTime': FromDateTime, 'toDateTime': ToDateTime }),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (FivePerFormingForms) {
                ...
                if (FivePerFormingForms != undefined && FivePerFormingForms != null && FivePerFormingForms.length > 0) {
                    ...
                    for (let i = 0; i < FivePerFormingForms.length; i++) {
                        ...
                        if (FivePerFormingForms[i].EmbeddedFormOrPopUpFormOrTaggedForm != null && FivePerFormingForms[i].EmbeddedFormOrPopUpFormOrTaggedForm != "" && FivePerFormingForms[i].EmbeddedFormOrPopUpFormOrTaggedForm.length > 0)
                            FormType = FivePerFormingForms[i].EmbeddedFormOrPopUpFormOrTaggedForm == "PopUpForm" ? "Pop-Up Form" : FivePerFormingForms[i].EmbeddedFormOrPopUpFormOrTaggedForm == "EmbeddedForm" ? "Embedded Form" : "Tagged Form";
    ...
    GetPlatformDistribution: function () {
        $.ajax({
            url: "/CaptureForm/Dashboard/GetPlatformDistribution",
            type: 'Post',
            data: JSON.stringify({ 'accountId': Plumb5AccountId, 'fromDateTime': FromDateTime, 'toDateTime': ToDateTime }),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (PlatformDistribution) {
                ...
                if (PlatformDistribution != undefined && PlatformDistribution != null) {
                    dashboardUtil.BindChartForPlatformDistribution(PlatformDistribution.MobileCount, PlatformDistribution.WebCount);
                } else {
    ...
    BindChartForPlatformDistribution: function (MobileCount, WebCount) {
    ...
    GetFirstAggregateFormsData: function () {
        $.ajax({
            url: "/CaptureForm/Dashboard/GetAggregateFormsData",
            type: 'Post',
            data: JSON.stringify({ 'accountId': Plumb5AccountId, 'fromDateTime': FromDateTime, 'toDateTime': ToDateTime }),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
